...
const demoAccounts = [
  { role: "Owner", email: "owner@auto7.id", password: "Owner@Auto7" },
  { role: "Admin", email: "admin@auto7.id", password: "Admin@Auto7" },
  { role: "Mekanik", email: "mekanik@auto7.id", password: "Mekanik@Auto7" },
  { role: "Kasir", email: "kasir@auto7.id", password: "Kasir@Auto7" },
];
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900 sm:p-8">
        <div className="mb-7 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Gunakan akun bengkel yang sudah terdaftar.
          </p>
        </div>
            ...
            <div className="mt-4 rounded-xl bg-gray-50 p-4 dark:bg-white/[0.04]">
              ...
              <div className="space-y-3">
                {demoAccounts.map((account) => (
                  <div
                    key={account.email}
                    className="grid grid-cols-[76px_1fr] gap-3 text-sm"
                  >
