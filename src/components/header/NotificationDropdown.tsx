        ...
        <ul className="custom-scrollbar flex h-auto flex-col overflow-y-auto">
          {latestNotifications.map((notification) => (
            <li key={notification.id}>
              ...
              >
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-50 text-sm font-semibold text-brand-600 dark:bg-brand-500/10 dark:text-brand-300">
                ...
                <span className="block min-w-0">
                  <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span className="font-medium text-gray-800 dark:text-white/90">
                      {entityLabel(notification.entity)}
                    </span>
                    {notification.entityNo && ` ${notification.entityNo}`}
                  </span>
                  ...
                  <span className="flex items-center gap-2 text-theme-xs text-gray-500 dark:text-gray-400">
                    <span>{notification.status || "Aktivitas"}</span>
